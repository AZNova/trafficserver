...
public:
  ...
  */
  ...
  void
  set_proxy_protocol_src_addr(ts::ConstBuffer src)
  {
    set_proxy_protocol_addr(PROXY_PROTO_SRC, src);
  }

  void
  set_proxy_protocol_dst_addr(ts::ConstBuffer src)
  {
...
private:
  ...
  int set_proxy_protocol_addr(ProxyProtocolData_t, ts::ConstBuffer);
