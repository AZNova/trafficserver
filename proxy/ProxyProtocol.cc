...
{
  //ts::ConstBuffer src_addr_port;
  std::string src_addr_port;
  //ts::ConstBuffer dst_addr_port;
  ...
  while (pch != NULL) {
    ...
    case 4:
      ...
      netvc->set_proxy_protocol_src_addr(ts::ConstBuffer(src_addr_port.c_str(), src_addr_port.length()));
    ...
    case 5:
      ...
      netvc->set_proxy_protocol_dst_addr(ts::ConstBuffer(dst_addr_port.c_str(), dst_addr_port.length()));
