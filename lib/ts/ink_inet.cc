...
const ts::string_view IP_PROTO_TAG_PROXY_V1("PROXY"_sv); // PROXY v1 Protocol
const ts::string_view IP_PROTO_TAG_PROXY_V2("Some binary signature - figure this out laster"_sv); // PROXY v2 Protocol
